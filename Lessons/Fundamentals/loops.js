...
2. defines the condition of the loop to run (in this examples: its going to continue until i reaches ten)
...
for(let i=0; i< city.length; i++){console.log(city[i])}

// ? Create a for loop that starts at 1 and goes to 100 and console logs (i)
...
for (let i = 0; i <=100; i=i+2) {console.log(i)}
